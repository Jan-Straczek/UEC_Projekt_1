...
HD_PWD='C:/Users/Jakub/OneDrive/Pulpit/Projekt cyfrwka v2/pulse_generator/pulse_generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pulse_Generator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pulse_Generator.tcl -notrace
