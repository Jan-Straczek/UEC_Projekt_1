...
HD_PWD='C:/Users/Jakub/OneDrive/Pulpit/Projekt cyfrwka v2/stepper_motor_movement/stepper_motor_movement.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_printer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_printer.tcl -notrace
