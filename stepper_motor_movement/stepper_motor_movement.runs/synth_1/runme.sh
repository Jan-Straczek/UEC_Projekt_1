...
HD_PWD='C:/Users/Jakub/OneDrive/Pulpit/Projekt cyfrwka v2/stepper_motor_movement/stepper_motor_movement.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_printer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_printer.tcl
